...
CREATE TABLE region (
    ...
    regiondescription character varying(128) NOT NULL
);
...
CREATE TABLE territories (
    territoryid character varying(20) NOT NULL,
    territorydescription character varying(256) NOT NULL,
    regionid smallint NOT NULL
);
...
COPY usstates (stateid, statename, stateabbr, stateregion) FROM stdin;
1	Alabama	AL	south
2	Alaska	AK	north
3	Arizona	AZ	west
4	Arkansas	AR	south
...
--
-- Name: cust_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY orders
    ADD CONSTRAINT cust_fkey FOREIGN KEY (customerid) REFERENCES customers(customerid) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: emp_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY orders
    ADD CONSTRAINT emp_fkey FOREIGN KEY (employeeid) REFERENCES employees(employeeid) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: ord_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY order_details
    ADD CONSTRAINT ord_fkey FOREIGN KEY (orderid) REFERENCES orders(orderid) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: prod_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY order_details
    ADD CONSTRAINT prod_fkey FOREIGN KEY (productid) REFERENCES products(productid) ON UPDATE CASCADE ON DELETE CASCADE;
